...
**Cross-ref:** ADR-NNNN, rule `.claude/rules/...`, outro módulo ou `Não aplicável nesta versão`
```
...
> Coerência com `.claude/rules/conventions/language-policy.md` e `.claude/rules/architecture/ddd.md`.
...
> Coerência com `.claude/rules/domain/money-as-cents.md` e `.claude/rules/domain/nbr-5891-rounding.md`.
...
> Coerência com `.claude/rules/domain/audit-immutability.md`, `.claude/rules/architecture/security-and-compliance.md` e `.claude/rules/architecture/observability.md`.

...
1. **Leitura prévia obrigatória dos insumos:**
   ...
   - Rules transversais em `.claude/rules/`
...
- `.claude/rules/conventions/language-policy.md`
- `.claude/rules/conventions/document-versioning.md`
- `.claude/rules/conventions/no-summary-files.md`
- `.claude/agents/specifications/requirements-writer.md` — autor de `requirements.md` por módulo (etapa posterior ao PRD)
- `.claude/agents/architecture/adr-writer.md` — autor de ADRs (quando o PRD identificar decisão arquitetural)

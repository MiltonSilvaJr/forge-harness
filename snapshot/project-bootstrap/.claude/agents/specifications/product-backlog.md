...
- `.claude/rules/conventions/conventional-commits.md` — formato de mensagens de commit (referenciado no DoD)
- `.claude/rules/testing/quality-gates.md` — coverage thresholds (referenciado no DoD)
- `.claude/rules/conventions/git-worktree.md` — workflow de branches por sprint

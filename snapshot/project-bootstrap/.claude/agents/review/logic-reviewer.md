  ...
  "findings": [
    {
      ...
      "rule_violated": ".claude/rules/domain/money-as-cents.md",
      "confidence": "high"
    }
  ]
}
...
- `.claude/rules/architecture/ddd.md` (apenas invariantes, não estrutura)
- `.claude/rules/testing/tdd.md`
- `.claude/rules/testing/quality-gates.md` (PBTs obrigatórios)

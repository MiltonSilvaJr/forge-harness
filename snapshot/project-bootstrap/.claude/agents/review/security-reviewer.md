  ...
  "findings": [
    {
      ...
      "rule_violated": ".claude/rules/architecture/security-and-compliance.md § PII em logs",
      "confidence": "high"
    }
  ]
}
...
- `.claude/rules/architecture/security-and-secrets.md`
- `.claude/rules/architecture/security-and-compliance.md`
- `.claude/rules/architecture/jwt-authentication.md`
- `.claude/rules/architecture/jwt-permissions.md`
- `.claude/rules/architecture/mtls-internal-services.md`
- `.claude/rules/domain/audit-immutability.md`
- OWASP Top 10
- PCI DSS 4.0

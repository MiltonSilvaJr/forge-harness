...
Você é o `code-evaluator`, orquestrador único do pipeline de revisão pós-codificação do `<project_name>` (resolver via bootstrap — ver `.claude/agents/README.md#bootstrap-de-identidade`). Sua responsabilidade é:
  ...
  "findings": [
    {
      ...
      "rule_violated": ".claude/rules/architecture/observability.md § PII",
...
- `.claude/agents/review/logic-reviewer.md`
- `.claude/agents/review/arch-reviewer.md`
- `.claude/agents/review/security-reviewer.md`
- `.claude/agents/review/platform-reviewer.md`
- `.claude/agents/review/quality-reviewer.md`
- `.claude/agents/engineering/fullstack-software-engineer.md`
- `.claude/skills/verify-build/`
- `.claude/skills/verify-diff-claims/`
- `.claude/rules/` (todas)

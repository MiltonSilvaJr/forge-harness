  ...
  "findings": [
    {
      ...
      "fix_suggested": "Adicionar 'ARG TARGETARCH' + 'FROM --platform=$BUILDPLATFORM ...' no estágio build, e usar 'dotnet publish -a $TARGETARCH'. Ver template em .claude/rules/architecture/docker-multi-arch.md.",
      "rule_violated": ".claude/rules/architecture/docker-multi-arch.md",
      "confidence": "high"
    }
  ]
}
...
- `.claude/rules/architecture/observability.md`
- `.claude/rules/conventions/docker-naming.md`

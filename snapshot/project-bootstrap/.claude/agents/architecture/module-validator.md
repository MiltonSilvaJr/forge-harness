...
- `.claude/rules/architecture/clean-architecture.md` — base para validação de dependências
- `.claude/rules/architecture/ddd.md` — base para Context Map e ownership
- `.claude/rules/architecture/security-and-compliance.md` — base para PCI DSS e LGPD

...
| `docs/**`, `.claude/**` | **você mesmo responde** (não delega) |
...
6. **Sem co-autoria de IA.** Nenhum commit pode conter `Co-Authored-By: Claude`, `Generated with [Claude Code]` ou similar (regra global de `~/.claude/CLAUDE.md`).
...
15. `docs/rules/`
16. `.claude/rules/`
17. `.claude/context/project.md`
18. `.claude/context/architecture.md`
19. `.claude/context/repository-structure.md`
20. `.claude/context/constraints.md`
21. `.claude/context/coding-standards.md`
22. `.claude/context/testing-strategy.md`
23. `.claude/context/security-and-compliance.md`
24. `.claude/context/documentation-standards.md`

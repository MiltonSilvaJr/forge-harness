...
/deploy-wave payment-processing stg --sha abc1234

# Deploy em produção (exige aprovador)
/deploy-wave payment-processing prd --approved-by "Milton Antonio da Silva Jr"

# Canary em stg
/deploy-wave payment-processing stg --strategy canary
```
...
✅ Deploy concluído em 412s.
   ...
   - Promover para stg: /deploy-wave payment-processing stg
```
...
- `.claude/agents/coding/deploy-orchestrator.md` (agent invocado)
- `.claude/rules/architecture/docker-multi-arch.md`
- `.claude/rules/architecture/docker-image-security.md` (zero tolerance CVE)

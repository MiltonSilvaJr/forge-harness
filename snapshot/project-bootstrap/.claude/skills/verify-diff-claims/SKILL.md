...
Match → finding `CLAIM-AUTHORSHIP` severidade **BLOCKER** (regra global de `~/.claude/CLAUDE.md`).
...
```json
{
  ...
  "findings_to_emit": [
    ...
    },
    {
      ...
      "rule_violated": "~/.claude/CLAUDE.md — Convenções de commit"
    }
  ],
  "matched_claims": [
...
- `.claude/rules/conventions/conventional-commits.md` — scopes canônicos
